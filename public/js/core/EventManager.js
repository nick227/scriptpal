...
export class EventManager {
    ...
    static EVENTS = {
        ...
        SCRIPT: {
            SELECT_REQUESTED: 'SCRIPT:SELECT_REQUESTED',
            CREATE_REQUESTED: 'SCRIPT:CREATE_REQUESTED',
            DELETE_REQUESTED: 'SCRIPT:DELETE_REQUESTED',
            LIST_REQUESTED: 'SCRIPT:LIST_REQUESTED',
